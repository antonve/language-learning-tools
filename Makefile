...
migrate_docker:
	...
	docker compose exec api bash -c "migrate -source file://internal/pkg/storage/postgres/migrations -database postgres://root:hunter2@postgres:5432/mining_tools?sslmode=disable $(MIGRATION_ARGS)"
